...
public class Pasantias extends javax.swing.JPanel {
    ...
    private void modificarPasantias() {
        ...
        String autor = (String) table.getValueAt(fila, 2);
        String cedula = (String) table.getValueAt(fila, 3);
        String fecha = (String) table.getValueAt(fila, 4);
        String especialidad = (String) table.getValueAt(fila, 5);
        String enumeracion = (String) table.getValueAt(fila, 6);
        ...
        idField.setEditable(false); // Hacer el campo ID no editable
        JLabel tituloLabel = new JLabel("Titulo:");
        ...
        if (result == JOptionPane.OK_OPTION) {
            try {
                if (tituloField.getText().isBlank() || autorField.getText().isBlank() || cedulaField.getText().isBlank() || fechaField.getText().isBlank() || especialidadField.getText().isBlank()) {
                    ...
                    Conexion cn = new Conexion();
                    Connection conexion = cn.conectar();
                    String sql = "UPDATE Pasantias SET Titulo = ?, Autor = ?, Cedula = ?, Fecha = ?, Especialidad = ?, Enumeracion = ? WHERE ID_Informe = ?";
                    ...
                    if (rowsAffected > 0) {
                        ...
                        table.setValueAt(tituloField.getText(), fila, 1);
                        table.setValueAt(autorField.getText(), fila, 2);
                        table.setValueAt(cedulaField.getText(), fila, 3);
                        table.setValueAt(fechaField.getText(), fila, 4);
                        table.setValueAt(especialidadField.getText(), fila, 5);
                        table.setValueAt(enumeracionField.getText(), fila, 6);
                    } else {
    ...
    String sql = "DELETE FROM pasantias WHERE ID_Informe = ?"; // Usa un parámetro en la consulta SQL
    ...
    try {
     ...
     private void eliminarPasantias(){
        ...
        if (result == JOptionPane.OK_OPTION) {
            try {
                if (tituloField.getText().isBlank()) {
                    ...
                    String sql = "DELETE FROM pasantias WHERE ID_Informe = ?";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Detalles de pasantias");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(panel2, javax.swing.GroupLayout.DEFAULT_SIZE, 1126, Short.MAX_VALUE)
                    .addComponent(panelBorder1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(busqueda_field, javax.swing.GroupLayout.DEFAULT_SIZE, 1128, Short.MAX_VALUE)
                    .addComponent(panel, javax.swing.GroupLayout.DEFAULT_SIZE, 1110, Short.MAX_VALUE))
                .addGap(20, 20, 20))
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(20, 20, 20)
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        ...
        int fila=table.getSelectedRowCount();
        if(fila<0){
            JOptionPane.showMessageDialog(null, "Seleccione un registro");
        }
        else{
            if(eliminar(table.getValueAt(table.getSelectedRow(),0).toString())){
